...

{
    ...
    section "Start (Window Mgmt)"
    controller "Start + A"          "Toggle floating"
    controller "Start + B"          "Kill window"
    controller "Start + X"          "Toggle fullscreen"
    controller "Start + LB"         "Move window to prev workspace"
    controller "Start + RB"         "Move window to next workspace"
    controller "Start + LT"         "Move window (drag)"
    controller "Start + RT"         "Resize window (drag)"
    controller "Start + Y"          "Open terminal"
    controller "Start + Back"       "Notification history"

    section "Guide (Apps & Media)"
    controller "Guide + X"          "App launcher (rofi)"
    controller "Guide + Y"          "File manager"
    controller "Guide + A"          "Enter"
    controller "Guide + DL"         "Cheatsheet"
    ...
    section "Back (Quick Keys)"
    controller "Back + X"           "F"
    controller "Back + A"           "C"
    controller "Back + B"           "Reload i3"

    section "Standalone"
    controller "A"                  "Left click"
    controller "B"                  "Escape"
    controller "X"                  "Space"
    controller "Y"                  "Virtual keyboard"
