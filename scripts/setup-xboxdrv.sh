...
echo "  Guide+LT             Screenshot (Flameshot)"
echo "  Guide+RT             Clipboard manager (CopyQ)"
...
echo "  Start+Back           Move window to next workspace"
...
echo "  Guide+1-0            Switch workspace 1-10"
