...

{
    ...
    controller "Guide"               "Escape"
    controller "Guide + RB / LB"    "Next / prev workspace"
    controller "Guide + B"          "Kill focused window"
    controller "Guide + L3"         "Fullscreen"
    controller "Guide + A"          "File manager"
    controller "Guide + X"          "System power menu"
    controller "Guide + Start"      "Reload i3 config"
    controller "Guide + Y"          "Notification history"
    controller "Guide + LT"         "Screenshot (Flameshot)"
    controller "Guide + RT"         "Clipboard manager (CopyQ)"
    controller "Guide + Back"       "Close notification"
    controller "Guide + du / dd"    "Volume up / down"
    controller "Guide + dl"         "Mute"
    controller "Guide + dr"         "Play / pause"
    controller "Start"              "App launcher (rofi)"
    controller "Back"               "Open terminal"
    controller "Start + Back"       "Move window to next workspace"
    controller "X"                  "Open this cheatsheet"
    controller "Y"                  "Toggle virtual keyboard"
    controller "A"                  "Left click"
    controller "LT"                 "Middle click"
    controller "B"                  "Right click"
    controller "RT"                 "Toggle floating"
    controller "D-pad"              "Arrow keys"
    controller "Left stick"         "Mouse movement"
    controller "Right stick"        "Scroll"
    controller "L3 + R3"            "Toggle desktop / game mode"
    printf '\n'
